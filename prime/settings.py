...
# So don't have to give absolute path for each individual machine (e.g. diff developers/locations)
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'prime',                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = '/var/www/prime/static/'
...
SECRET_KEY = '@&=u3@8)&qdbk)-o&7bg^!*r9!yv%x&cct893h0*h)a$jj^&v0'
